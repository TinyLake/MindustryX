...
public class RenderExt{
    ...
    public static final SliderPref hiddenItemTransparency0 = new SliderPref("block.hiddenItemTransparency", 0, 0, 100, 2, v -> VarsX.getUiTextBundle().percentOrOff(v)); // 原文本:关闭
    public static final SliderPref overdriveZoneTransparency0 = new SliderPref("block.overdriveZoneTransparency", 0, 0, 100, 2, v -> VarsX.getUiTextBundle().percentOrOff(v)); // 原文本:关闭
    public static final SliderPref mendZoneTransparency0 = new SliderPref("block.mendZoneTransparency", 0, 0, 100, 2, v -> VarsX.getUiTextBundle().percentOrOff(v)); // 原文本:关闭
    public static final SliderPref healthBarMinHealth = new SliderPref("block.healthBarMinHealth", 0, 0, 4000, 50, v -> VarsX.getUiTextBundle().hpOrAll(v)); // 原文本:全部显示
