...
public class RenderExt{
    ...
    public static final SliderPref hiddenItemTransparency0 = new SliderPref("block.hiddenItemTransparency", 0, 0, 100, 2, v -> VarsX.bundle.percentOrOff(v));
    public static final SliderPref overdriveZoneTransparency0 = new SliderPref("block.overdriveZoneTransparency", 0, 0, 100, 2, v -> VarsX.bundle.percentOrOff(v));
    public static final SliderPref mendZoneTransparency0 = new SliderPref("block.mendZoneTransparency", 0, 0, 100, 2, v -> VarsX.bundle.percentOrOff(v));
    public static final SliderPref healthBarMinHealth = new SliderPref("block.healthBarMinHealth", 0, 0, 4000, 50, v -> VarsX.bundle.hpOrAll(v));
    public static final ChoosePref blockRenderLevel0 = new ChoosePref("block.renderLevel", CollectionsKt.listOf(mindustryX.bundles.UiTextBundle.i("隐藏全部建筑"), mindustryX.bundles.UiTextBundle.i("只显示建筑状态"), mindustryX.bundles.UiTextBundle.i("全部显示")), 2);
