...
public class AuxiliaryTools extends ToolTableBase{
    ...
    protected void rebuild(){
        ...
        button(Icon.eyeSmall, RStyles.clearLineNoneTogglei, iconMed, () -> {
            Settings.toggle("viewMode");
            boolean setting = Core.settings.getBool("viewMode");
            UIExt.announce("已" + (setting ? "开启" : "取消") + "视角脱离玩家");
            if(setting){
        ...
        }).tooltip("视角脱离玩家", true).checked(b -> Core.settings.getBool("viewMode"));
