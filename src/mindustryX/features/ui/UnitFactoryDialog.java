...
public class UnitFactoryDialog extends BaseDialog{
    ...
    public UnitFactoryDialog(){
        super(mindustryX.bundles.UiTextBundle.i("单位工厂"));
    ...
    private void setup(){
        ...
        buttons.button(mindustryX.bundles.UiTextBundle.i("重置"), Icon.refresh, () -> {
            resetUnit(spawnUnit);
            rebuildTables();
        });
        buttons.button(mindustryX.bundles.UiTextBundle.i("[orange]生成！"), Icon.modeAttack, this::spawn);
    ...
    private void rebuild(){
        ...
        rightTable.table(Tex.pane, settings -> {
            ...
            settings.table(randDstTable -> {
                randDstTable.add(mindustryX.bundles.UiTextBundle.i("生成范围："));
                randDstTable.field(Strings.autoFixed(unitRandDst, 3), text -> unitRandDst = Float.parseFloat(text)).valid(Strings::canParsePositiveFloat).tooltip(mindustryX.bundles.UiTextBundle.i("在目标点附近的这个范围内随机生成")).maxTextLength(6).padLeft(4f);
                randDstTable.add(mindustryX.bundles.UiTextBundle.i("格")).expandX().left();
            }).row();
    ...
    private void setupPosTable(){
        posTable.add(mindustryX.bundles.UiTextBundle.i("生成位置:"));
        ...
        posTable.button(Icon.pickSmall, Styles.clearNonei, () -> {
            ...
            UIExt.announce(mindustryX.bundles.UiTextBundle.i("[green]点击屏幕采集坐标"), 2f);
        });
        ...
        posTable.button(Icon.eyeSmall, Styles.clearNonei, () -> {
            ...
            UIExt.announce(mindustryX.bundles.UiTextBundle.i("[green]点击屏幕返回"), 2f);
        }).padLeft(4);
    ...
    private void setupCountTable(){
        countTable.add(mindustryX.bundles.UiTextBundle.i("生成数量:"));
    ...
    private void rebuildPropertiesTable(Unit unit, Table propertiesTable){
        ...
        propertiesTable.table(t -> t.check(mindustryX.bundles.UiTextBundle.i("飞行模式"), unit.elevation > 0, a -> unit.elevation = a ? 1 : 0).padBottom(5f).padRight(10f).tooltip(mindustryX.bundles.UiTextBundle.i("[orange]生成的单位会飞起来"), true)
        .checked(b -> unit.elevation > 0));

        propertiesTable.row();

        propertiesTable.table(healthTable -> {
            healthTable.add(mindustryX.bundles.UiTextBundle.i("[red]血量："));
        ...
        propertiesTable.table(shieldTable -> {
            shieldTable.add(mindustryX.bundles.UiTextBundle.i("[yellow]护盾："));
    ...
    private void rebuildItemTable(Unit unit, Table itemTable){
        ...
        itemTable.add(mindustryX.bundles.UiTextBundle.i("携带物品:"));
    ...
    private void rebuildTeamTable(Unit unit, Table teamTable){
        ...
        teamTable.add(mindustryX.bundles.UiTextBundle.i("生成队伍:"));
        teamTable.label(() -> {
            Team team = unit.team;
        ...
        teamTable.add(mindustryX.bundles.UiTextBundle.i("队伍ID:")).padLeft(4);
    ...
    private void rebuildEffectsTable(Unit unit, Table effectTable){
        ...
        Runnable rebuildInfo = () -> {
            ...
            effectInfo.add(mindustryX.bundles.UiTextBundle.i("[red]伤害"));
            effectInfo.add(FormatDefault.format(status[0])).expandX().right();

            effectInfo.add(mindustryX.bundles.UiTextBundle.i("[acid]血量")).padLeft(12f);
            effectInfo.add(FormatDefault.format(status[1])).expandX().right();
            effectInfo.row();

            effectInfo.add(mindustryX.bundles.UiTextBundle.i("[cyan]移速"));
            effectInfo.add(FormatDefault.format(status[2])).expandX().right();

            effectInfo.add(mindustryX.bundles.UiTextBundle.i("[violet]攻速")).padLeft(12f);
            effectInfo.add(FormatDefault.format(status[3])).expandX().right();
            effectInfo.row();

            effectInfo.add(mindustryX.bundles.UiTextBundle.i("[accent]建速"));
            effectInfo.add(FormatDefault.format(status[4])).expandX().right();

            effectInfo.add(mindustryX.bundles.UiTextBundle.i("[purple]阻力")).padLeft(12f);
            effectInfo.add(FormatDefault.format(status[5])).expandX().right();
            effectInfo.row();

            if(status[6] >= 0){
                effectInfo.add(mindustryX.bundles.UiTextBundle.i("[teal]装甲"));
        ...
        unitStatus.each(entry -> {
            ...
            table.table(Tex.whiteui, t -> {
                ...
                if(entry.effect.permanent){
                    t.add(mindustryX.bundles.UiTextBundle.i("<永久状态>")).expandX();
                }else if(entry.effect.reactive){
                    t.add(mindustryX.bundles.UiTextBundle.i("<瞬间状态>")).expandX();
                }else{
                    t.table(bottom -> {
                        ...
                        bottom.add(mindustryX.bundles.UiTextBundle.i("秒"));
            ...
            if(effect.dynamic) table.add(new Card(Pal.darkestGray, Card.grayOuterDark, t -> {
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[red]伤害")).style(Styles.outlineLabel);
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[acid]血量")).style(Styles.outlineLabel);
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[cyan]移速")).style(Styles.outlineLabel);
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[violet]攻速")).style(Styles.outlineLabel);
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[accent]建速")).style(Styles.outlineLabel);
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[purple]阻力")).style(Styles.outlineLabel);
                ...
                t.add(mindustryX.bundles.UiTextBundle.i("[teal]装甲")).style(Styles.outlineLabel);
    ...
    private void rebuildPayloadTable(Unit unit, Table payloadTable){
        ...
        payloadTable.table(Tex.whiteui, table -> {
            ...
            table.table(Styles.grayPanel, buttons -> {
                ...
                buttons.button(mindustryX.bundles.UiTextBundle.i("装载建筑"), new TextureRegionDrawable(Blocks.siliconSmelter.uiIcon), Styles.flatt, 32,
                ...
                buttons.button(mindustryX.bundles.UiTextBundle.i("装载单位"), new TextureRegionDrawable(UnitTypes.alpha.uiIcon), Styles.flatt, 32f,
                ...
                buttons.button(mindustryX.bundles.UiTextBundle.i("装载自己"), Icon.add, Styles.flatt, () -> {
    ...
    private void simpleFactory(Unit unit){
        BaseDialog dialog = new BaseDialog(mindustryX.bundles.UiTextBundle.i("单位工厂"));
        ...
        dialog.buttons.button(mindustryX.bundles.UiTextBundle.i("重置"), Icon.refresh, () -> {
            resetUnit(unit);
            rebuildTables();
        });
    ...
    private static class UnitStack{
        ...
        public String name(){
            return mod == null ? Core.bundle.get("vanilla", mindustryX.bundles.UiTextBundle.i("原版")) : mod.meta.displayName;
        }
