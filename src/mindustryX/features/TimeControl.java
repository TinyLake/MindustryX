...
public class TimeControl{
    ...
    public static void draw(Table table){
        ...
        table.button("/2", Styles.cleart, () -> setGameSpeed(gameSpeed * 0.5f)).tooltip(mindustryX.bundles.UiTexts.i("将时间流速放慢到一半")).size(40f, 30f); // 原文本:将时间流速放慢到一半
        table.button("×2", Styles.cleart, () -> setGameSpeed(gameSpeed * 2f)).tooltip(mindustryX.bundles.UiTexts.i("将时间流速加快到两倍")).size(40f, 30f); // 原文本:将时间流速加快到两倍
        table.button("[red]S", Styles.cleart, () -> setGameSpeed(0f)).tooltip(mindustryX.bundles.UiTexts.i("暂停时间")).size(30f, 30f); // 原文本:暂停时间
        table.button("[green]N", Styles.cleart, () -> setGameSpeed(1f)).tooltip(mindustryX.bundles.UiTexts.i("恢复原速")).size(30f, 30f); // 原文本:恢复原速
        table.button("[white]F", Styles.cleart, TimeControl::setFpsLock).tooltip(mindustryX.bundles.UiTexts.i("帧率模拟")).size(30f, 30f); // 原文本:帧率模拟
        ...
        }).tooltip(mindustryX.bundles.UiTexts.i("允许的范围：2~9999")).size(80f, 30f); // 原文本:允许的范围：2~9999
    }
}
