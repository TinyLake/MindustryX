...
public class ArcOld{
    ...
    public static void nextBackground(Image image){
        ...
        mainExecutor.submit(() -> {
            try{
                ...
                Core.app.post(() -> ui.showException(VarsX.getUiTextBundle().invalidBackgroundImage(file.path()), e));
            }
        });
    }
    ...
    public static void addSettings(){
        Vars.ui.settings.addCategory("@settings.arc", Icon.star, (c) -> {
            ...
            c.sliderPref("mass_driver_line_interval", 40, 8, 400, 4, i -> VarsX.getUiTextBundle().tiles(i / 8f)); // 原文本:格
            {
            ...
            c.sliderPref("turretShowRange", 0, 0, 3, 1, s -> VarsX.getUiTextBundle().turretShowRangeMode(s));
            c.checkPref("turretForceShowRange", false);
            c.sliderPref("turretAlertRange", 0, 0, 30, 1, i -> VarsX.getUiTextBundle().tilesOrOff(i)); // 原文本:格 | 关闭
            ...
            c.sliderPref("unitWeaponRange", settings.getInt("unitAlertRange", 0), 0, 30, 1, s -> VarsX.getUiTextBundle().unitWeaponRangeMode(s));
            c.sliderPref("unitWeaponRangeAlpha", settings.getInt("unitweapon_range", 0), 0, 100, 1, i -> VarsX.getUiTextBundle().percentOrOff(i)); // 原文本:关闭
            ...
            c.sliderPref("unitTargetType", 0, 0, 5, 1, s -> VarsX.getUiTextBundle().unitTargetTypeMode(s));
            c.sliderPref("superUnitEffect", 0, 0, 2, 1, s -> VarsX.getUiTextBundle().superUnitEffectMode(s));
